...
<main>
	<h1 class="slideInDown animated">Add an Employee or update his information <br> or remove him</h1>
	<div class="form-style-5 slideInDown animated">
		<form enctype="multipart/form-data">
			<fieldset>
				<label for="Device"><b>Employee's Department:</b></label>
			...
			<legend><span class="number">1</span> Employee Fingerprint ID:</legend>
			...
			<fieldset>
				<legend><span class="number">2</span> Employee Info</legend>
